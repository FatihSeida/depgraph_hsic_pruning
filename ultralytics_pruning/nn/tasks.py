...
from ultralytics_pruning.nn.autobackend import check_class_names
from ultralytics_pruning.nn.modules import (
    AIFI,
    C1,
    C2,
    C2PSA,
...
from ultralytics_pruning.utils import DEFAULT_CFG_DICT, DEFAULT_CFG_KEYS, LOGGER, colorstr, emojis, yaml_load
from ultralytics_pruning.utils.checks import check_requirements, check_suffix, check_yaml
from ultralytics_pruning.utils.loss import (
    E2EDetectLoss,
...
from ultralytics_pruning.utils.ops import make_divisible
from ultralytics_pruning.utils.plotting import feature_visualization
from ultralytics_pruning.utils.torch_utils import (
    fuse_conv_and_bn,
    fuse_deconv_and_bn,
    initialize_weights,
    intersect_dicts,
...
class YOLOEModel(DetectionModel):
    ...
    def get_text_pe(self, text, batch=80, cache_clip_model=False, without_reprta=False):
        ...
        """
        from ultralytics_pruning.nn.text_model import build_text_model
