...
from ultralytics_pruning import __version__
from ultralytics_pruning.utils.patches import imread, imshow, imwrite, torch_load, torch_save  # for patches
...
LOGGING_NAME = "ultralytics_pruning"
...
class TQDM(rich.tqdm if TQDM_RICH else tqdm.tqdm):
    ...
    Examples:
        >>> from ultralytics_pruning.utils import TQDM
